...
var player_path = preload("res://minigames/bbbattle/player/player.tscn")
var opponent = null
...
func add_opponent(opponent_id, opponent_info):
	...
	opponent = load("res://minigames/bbbattle/opponents/" + opponent_info["Character"] + "/opponent_scene.tscn").instantiate()
