...
@onready var mudScene = preload("res://minigames/karl_pilkington/assets/enemies/dumb frog/mud/mud.tscn")
...
func shoot_mud():
	var mud = mudScene.instantiate()
	spawn_entity(mud, $Marker2D.global_position, false)
	mud.final_pos = get_shoot_position(false)
