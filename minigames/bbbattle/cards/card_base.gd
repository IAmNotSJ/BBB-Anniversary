...
#@export var stats:CardStats = load("res://minigames/bbbattle/cards/card_variants/stats/0.tres")

@export var is_preview:bool = false
@export var selectable:bool = true
@export var do_offset:bool = true

@onready var shader_items = [[%Base, 0.2], [%Ability_Holder, 0.2], [%border, 0.2]]

const status_scene = preload("res://minigames/bbbattle/cards/status/card_status.tscn")
var statuses = []
...
func _on_stats_changed():
	if stats != null:
		...
		var path:String
		if FileAccess.file_exists("res://minigames/bbbattle/cards/card_variants/assets/" + stats["Card Number"] + "-c.png") and Saves.battle_settings["Censor Food"]:
			path = "res://minigames/bbbattle/cards/card_variants/assets/" + stats["Card Number"] + "-c.png"
		else:
			path = "res://minigames/bbbattle/cards/card_variants/assets/" + stats["Card Number"] + ".png"
