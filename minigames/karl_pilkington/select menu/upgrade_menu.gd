...
var upgrades = [
	...
	["The Cookie", "Woah!", "res://minigames/karl_pilkington/assets/items/cookie/cookie.tscn", preload("res://minigames/karl_pilkington/select menu/upgrade icons/cookie.png")],
