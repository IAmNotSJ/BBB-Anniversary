...
const draggable_card = preload("res://minigames/bbbattle/menu/deck_builder/draggable_card/draggable_card.tscn")
const normal_card = preload("res://minigames/bbbattle/cards/card.tscn")
...
func _create_cards():
	...
	for num in every_card:
			var file_path = "res://minigames/bbbattle/cards/card_variants/stats/" + num + ".tres"
